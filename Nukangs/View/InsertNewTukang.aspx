<%@ Page Title="" Language="C#" MasterPageFile="~/View/Navbar.Master" AutoEventWireup="true" CodeBehind="InsertNewTukang.aspx.cs" Inherits="Nukangs.View.InsertNewTukang" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="file-upload-container">
      ...
      <label for="fuImage" class="file-upload-label">
       <img alt="" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTr2TWLC89uQt3vWdCNxxESU3iK9Pj-acV5CA&usqp=CAU" id="imgTukang"/>
  ...
  <div title="Sign In" type="submit" class="sign-in_btn">
      <asp:Button ID="btnUpdate" runat="server" Text="Save Changes" OnClick="btnAddAlbum_Click" cssClass="btnSaveChanges"/>
  </div>
